...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros': [      # List of button macros...
        ...
        (0x002020, '>>', [[ConsumerControlCode.SCAN_NEXT_TRACK]]),
        # Encoder button ---
        (0x000000, '', [{'kp_self': 'off'}])
    ]
}
